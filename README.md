...
- [四、核心设计思想](#四核心设计思想)
  ...
  - [4.6 操作日志功能 - 数据审计与回滚机制](#46-操作日志功能---数据审计与回滚机制)
- [五、调试方法](#五调试方法)
...
> 💡 **详细说明**：关于操作日志的工作原理、依赖关系检查机制、配置方式等详细内容，请参考 [4.6 操作日志功能 - 数据审计与回滚机制](#46-操作日志功能---数据审计与回滚机制)。
